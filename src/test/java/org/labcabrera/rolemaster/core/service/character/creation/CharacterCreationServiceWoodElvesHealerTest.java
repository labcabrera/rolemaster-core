...
class CharacterCreationServiceWoodElvesHealerTest extends AbstractCharacterCreationTest {
	...
	protected void verify(CharacterInfo character) {
		assertEquals(4, character.getAttributes().get(AttributeType.AGILITY).getBonus().get(AttributeBonusType.RACE));
		...
		assertEquals(Arrays.asList(2, 6), character.getSkillCategory("body-development").get().getDevelopmentCost());
		assertEquals(Arrays.asList(6), character.getSkillCategory("power-point-development").get().getDevelopmentCost());
		...
		assertEquals(Arrays.asList(6), character.getSkillCategory("subterfuge-stealth").get().getDevelopmentCost());
		assertEquals(Arrays.asList(8), character.getSkillCategory("subterfuge-mechanics").get().getDevelopmentCost());
