...
public class CriticalTableService {
	...
	public void loadTables() throws IOException {
		tables.put(CriticalType.S, loadTable("data/table/rmss/critical/critical-table-s.json"));
		tables.put(CriticalType.P, loadTable("data/table/rmss/critical/critical-table-p.json"));
		tables.put(CriticalType.K, loadTable("data/table/rmss/critical/critical-table-k.json"));
		tables.put(CriticalType.G, loadTable("data/table/rmss/critical/critical-table-g.json"));
		tables.put(CriticalType.HEAT, loadTable("data/table/rmss/critical/critical-table-heat.json"));
	}
