package org.labcabrera.rolemaster.core.table.rmss.fumble;
...
public class FumbleTableService {
	...
	public void loadTables() throws IOException {
		try (
			InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("data/table/rmss/critical/fumble-table.json")) {
